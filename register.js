...
var List_1 = require("./src/components/List");
require("antd/dist/antd.css");
var types_1 = require("./src/types");
var create_title_listener_1 = require("./src/utils/create-title-listener");
var IDS;
(function (IDS) {
...
addons_1.addons.register(IDS.ADDON, function (api) {
    addons_1.addons.add(IDS.PANEL, {
        title: create_title_listener_1.createTitleListener(api),
        ...
        render: function (_a) {
            ...
            var interval = null;
            var notifyEntryChanges = function () { return addons_1.addons.getChannel().emit(types_1.EVENTS.UPDATE_COUNT, {
                entries: entries,
            }); };
            react_1.useEffect(function () {
                ...
                return function () {
                    ...
                    addons_1.addons.getChannel().removeListener(core_events_1.STORY_CHANGED, function () { return setEntries([]); });
                    addons_1.addons.getChannel().removeListener(types_1.EVENTS.REQUEST, onRequest);
                    addons_1.addons.getChannel().removeListener(types_1.EVENTS.RESPONSE, onResponse);
                    addons_1.addons.getChannel().removeListener(types_1.EVENTS.RESPONSE_ERROR, onResponseError);
                };
            });
