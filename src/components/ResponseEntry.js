...
var ResponseEntry = function (_a) {
    ...
    return (react_1.default.createElement(Panel, __assign({}, rest, { header: title, key: data.config.url, extra: react_1.default.createElement(icons_1.DownloadOutlined, null) }),
